...
#                                   print(req2.json())
 ...
 #                     print(token)
                      ...
                      ata={
                                       '_token':token,
                                       'full_name':'bambang sugiono',
                                       'email':'jsjidnsoisoeodi@gmail.com',
                                       'phone':num,
                                       'back-to':'',
                                       'submit':'Daftar',
                   }
...
[ Spam List ]
1. dokter bangsat (work)
2. dokter bejat (coba dulu work atau gk)
3. dokter kintil (work
              """)
                           pil=int(input("> Pilih: "))
                           print("="*25)
                           ...
                           if pil == 1:
                           	       ...
                           	       for i in range(lop):
                           	         ...
                           	         print("?: punya mata gk lu anjing!?")
                           lgi=input("\n[?] Coba lagi (Y/n) ")
                           if lgi.lower() == 'n':
                           	       sys.exit('yah keluar lu babi cuma comot doank:*')
